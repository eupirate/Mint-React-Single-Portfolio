  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <Portfolio />
        <Partners />
        <ReactPlayer controls className="ingressVideo1" url='https://youtu.be/RJ52YyG4BJQ' />
        <ReactPlayer controls className="ingressVideo2" url='https://youtu.be/gvkgbMCSc8A' />
        <About />
        <Blog />
        <Contact />
        <Footer />
